...
<head>
	...
	<title><?php echo "$nameTitle" ?></title> <!-- переменная в title-->
</head>
<body>
	<div id="content">
		<h1><?php echo 'hello,'. "$heading"  ?></h1> <!-- переменная в заголовок-->
		
		<ul id="menu">
			<li><a href="#"><?php echo "$hrefHome" ?></a></li> <!-- переменная в меню-->
